...
if __name__=="__main__":
    ...
    try:
        ...
        return_period_string = '_rp['+str(return_period)+'pt0].txt'
    except:
        #return_period_string = '_motion_0.txt'
        return_period_string = '_motion_0_spawn_0_gmm_0.txt'

    
    soil_response_file = location_file.replace('_locations.txt',('_soil_SA'+return_period_string))
    rock_response_file = location_file.replace('_locations.txt',('_bedrock_SA'+return_period_string))
    MMIoutfile = location_file[:-4]+'_mmi'+return_period_string.replace('[','').replace(']','') 
    MMI9outfile = location_file[:-4]+'_mmi9'+return_period_string.replace('[','').replace(']','') 
    rockoutfile = location_file[:-4]+'_bedrock'+return_period_string.replace('[','').replace(']','')
    soiloutfile = location_file[:-4]+'_soil'+return_period_string.replace('[','').replace(']','')
    #rockoutfile = location_file[:-4]+'_bedrock_SA_'+return_period_string + '_spawn_0_gmm_0.txt'.replace('[','').replace(']','')
    #soiloutfile = location_file[:-4]+'_soil_SA_'+return_period_string + '_spawn_0_gmm_0.txt'.replace('[','').replace(']','')
